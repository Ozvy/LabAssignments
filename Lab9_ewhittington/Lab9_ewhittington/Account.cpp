...
/// </summary>
/// <param name="accNum">The account number</param>
/// <param name="initalBalance">The initial balance</param>
/// <param name="customer">The customer object associated to the savings account</param>
SavingsAccount::SavingsAccount(const string& accNum, double initialBalance, const Customer& customer, double interestRate)
...
void SavingsAccount::closeOfBusiness() {
    double interest =  dailyInterestRate * balance;
...
/// <summary>
/// Prints a quick informational summary about the Savings Account
/// </summary>
